            ...
            return ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  double distanceInMeters = Geolocator.distanceBetween(
                      ...
                      snapshot.data!.docs[i]['longitude']);
                  // 24.903623, 67.198367, snapshot.data.docs[i]['latitude'],snapshot.data.docs[i]['longitude']);
                  //  print(double.parse(clatitude!));
                            ...
                            Container(
                              ...
                              child: GoogleMap(
                                ...
                                initialCameraPosition: CameraPosition(
                                    ...
                                    target: LatLng(double.parse(clatitude),
                                        double.parse(clongitude)),
                                    zoom: 12),
                                // 24.8679942
    ...
    return Container(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition:
            ...
            CameraPosition(
                target:
                    LatLng(double.parse(clatitude), double.parse(clongitude)),
                zoom: 5),
