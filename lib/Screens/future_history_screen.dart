...
class FutureHistoryPage extends StatefulWidget {
  ...
  FutureHistoryPage({Key? key, this.currentUserEmail}) : super(key: key);

  @override
  _FutureHistoryPageState createState() => _FutureHistoryPageState();
}
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(
                                        cityData['pickupDateTime']??"not selected",
                                        // snapshot.data!.docs[index]
                                        //     ['pickupDateTime'],
                                        // "1/14/2022 3:18 PM",
                                        style: TextStyle(
